...
urlpatterns = [
    ...
    path(
        "admin-panel/movies/<int:movie_id>/edit/",
        views.movie_update_view,
        name="movie_edit",
    ),
    path(
        "admin-panel/movies/<int:movie_id>/delete/",
        views.movie_delete_view,
        name="movie_delete",
    ),
    ...
    path(
        "admin-panel/cinemas/<int:pk>/delete/",
        views.cinema_delete_view,
        name="cinema_delete",
    ),
    # Halls
    path(
        "admin-panel/cinemas/<int:cinema_id>/halls/create/",
        views.hall_create_view,
        name="admin_hall_create",
    ),
    path(
        "admin-panel/halls/<int:pk>/edit/",
        views.hall_update_view,
        name="admin_hall_edit",
    ),
    path(
        "admin-panel/halls/<int:pk>/delete/",
        views.hall_delete_view,
        name="admin_hall_delete",
    ),
    # Public pages
    ...
    # API endpoints
    path(
        "api/booking/<int:session_id>/process/",
