...
class CustomUser(AbstractUser):
    ...
    gender = models.CharField(max_length=100,choices=Gender.choices, blank=True, null=True, default=Gender.MALE)
    language = models.CharField(max_length=100,choices=Language.choices,blank=True, null=True, default=Language.RUSSIAN)
